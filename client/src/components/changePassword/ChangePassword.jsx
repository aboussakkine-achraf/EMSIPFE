        ...
        <div className='lg:w-[60%] w-[100%] flex flex-col justify-between '>
            ...
            <div className='flex flex-col justify-center items-center h-[70vh] py-5'>
                <div className='text-center w-[60%]'>
                    <h2 className='text-2xl text-sky-600 font-semibold'>Nouveau mot de passe</h2>
                    <p className='py-3'>veuillez saisir un nouveau mot de passe</p>
                </div>
                <form className='flex flex-col justify-center items-center gap-y-3  text-start w-[40%] py-5'>
                    <input type="password" placeholder='Nouveau mot de passe' className=' border-sky-600 border-2 rounded-lg pl-2 h-9 w-[100%]'/>
                    <input type="password" placeholder='Confirmer le nouveau mot de passe' className=' border-sky-600 border-2 rounded-lg pl-2 h-9 w-[100%]'/>
                    <button className='bg-sky-600 text-white p-2 rounded-xl mt-3 px-5'>Changer le mot de passe</button>
