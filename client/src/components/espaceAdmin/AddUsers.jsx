        ...
        <div className='h-full w-full'>
          ...
          <form className='flex flex-col justify-center gap-y-4 w-[75%]' onSubmit={nouveauUser}>
              ...
              <select placeholder='Filier' className='border-black border-2 rounded-lg pl-2 h-9' value={filier} onChange={e=>setFilier(e.target.value)} required>
                <option value="ASEDS">INGÉNIERIE INFORMATIQUE ET RÉSEAUX</option>
                <option value="DATA">INGÉNIERIE FINANCIÈRE ET AUDIT</option>
                <option value="CLOUD">GÉNIE INDUSTRIEL</option>
                <option value="SESNUM">GÉNIE CIVIL, BÂTIMENTS ET TRAVAUX PUBLICS </option>
                <option value="ICCN">INGÉNIERIE AUTOMATISMES ET INFORMATIQUE INDUSTRIELLE</option>
